...
interface BurgerIngredientsContextInterface {
    burgerIngredients: Array<any>;
    setBurgerIngredients: any;
}
...
export const BurgerIngredientsContext = React.createContext<BurgerIngredientsContextInterface >({burgerIngredients: [], setBurgerIngredients: ()=> {}});